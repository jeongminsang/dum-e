...
**Source:** [`@dum-e/tui`](https://github.com/earendil-works/pi/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@dum-e/tui";
...
```typescript
import { Container, type Focusable, Input } from "@dum-e/tui";
...
Import from `@dum-e/tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@dum-e/tui";
```
...
```typescript
import { matchesKey, Key } from "@dum-e/tui";
...
```typescript
import { MouseRegion } from "@dum-e/tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@dum-e/tui";
...
```typescript
import { getMarkdownTheme } from "@dum-e/coding-agent";
import { Markdown } from "@dum-e/tui";
...
For letting users pick from a list of options. Use `SelectList` from `@dum-e/tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@dum-e/coding-agent";
import { DynamicBorder } from "@dum-e/coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@dum-e/tui";
...
```typescript
import { BorderedLoader } from "@dum-e/coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@dum-e/tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@dum-e/coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@dum-e/tui";
...
import { matchesKey, truncateToWidth } from "@dum-e/tui";
