...
```typescript
import { createAgentSession, ModelRuntime, SessionManager } from "@dum-e/coding-agent";
...
```bash
npm install @dum-e/coding-agent
```
...
```typescript
import { createAgentSession, SessionManager } from "@dum-e/coding-agent";
...
The `Agent` class (from `@dum-e/agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
```typescript
import { getModel } from "@dum-e/ai";
import { ModelRuntime } from "@dum-e/coding-agent";
...
```typescript
import { InMemoryCredentialStore } from "@dum-e/ai";
import { createAgentSession, ModelRuntime } from "@dum-e/coding-agent";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@dum-e/coding-agent";
...
```typescript
import { createAgentSession } from "@dum-e/coding-agent";
...
import { createAgentSession, defineTool } from "@dum-e/coding-agent";
...
```typescript
import type { InlineExtension } from "@dum-e/coding-agent";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@dum-e/coding-agent";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@dum-e/coding-agent";
