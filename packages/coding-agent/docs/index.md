...
```bash
npm uninstall -g @dum-e/coding-agent
```

For pnpm, Yarn, or Bun installs, use the matching global remove command: `pnpm remove -g @dum-e/coding-agent`, `yarn global remove @dum-e/coding-agent`, or `bun uninstall -g @dum-e/coding-agent`.
