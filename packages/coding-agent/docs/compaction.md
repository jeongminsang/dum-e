...
For TypeScript definitions in your project, inspect `node_modules/@dum-e/coding-agent/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@dum-e/coding-agent";
