...
import * as _bundledPiAgentCore from "@dum-e/agent-core";
import type { Provider } from "@dum-e/ai";
import * as _bundledPiAiCompat from "@dum-e/ai/compat";
import * as _bundledPiAiOauth from "@dum-e/ai/oauth";
import * as _bundledPiAiProviders from "@dum-e/ai/providers/all";
import type { KeyId } from "@dum-e/tui";
import * as _bundledPiTui from "@dum-e/tui";
...
// avoiding a circular dependency. Extensions can import from @dum-e/coding-agent.
...
const VIRTUAL_MODULES: Record<string, unknown> = {
	...
	"@dum-e/agent-core": _bundledPiAgentCore,
	"@dum-e/tui": _bundledPiTui,
	// Extensions resolve the pi-ai root to the compat entrypoint (a strict
	// superset of the core entrypoint): existing extensions using the old
	// global API keep working at runtime until compat is removed.
	"@dum-e/ai": _bundledPiAiCompat,
	"@dum-e/ai/compat": _bundledPiAiCompat,
	"@dum-e/ai/oauth": _bundledPiAiOauth,
	"@dum-e/ai/providers/all": _bundledPiAiProviders,
	"@dum-e/coding-agent": _bundledPiCodingAgent,
...
function getAliases(): Record<string, string> {
	...
	const piAgentCoreEntry = resolveWorkspaceOrImport("agent/dist/index.js", "@dum-e/agent-core");
	const piTuiEntry = resolveWorkspaceOrImport("tui/dist/index.js", "@dum-e/tui");
	// Extensions resolve the pi-ai root to the compat entrypoint (a strict
	// superset of the core entrypoint): existing extensions using the old
	// global API keep working at runtime until compat is removed.
	const piAiCompatEntry = resolveWorkspaceOrImport("ai/dist/compat.js", "@dum-e/ai/compat");
	const piAiOauthEntry = resolveWorkspaceOrImport("ai/dist/oauth.js", "@dum-e/ai/oauth");
	const piAiProvidersEntry = resolveWorkspaceOrImport("ai/dist/providers/all.js", "@dum-e/ai/providers/all");

	_aliases = {
		"@dum-e/coding-agent": piCodingAgentEntry,
		"@dum-e/agent-core": piAgentCoreEntry,
		"@dum-e/tui": piTuiEntry,
		"@dum-e/ai/providers/all": piAiProvidersEntry,
		"@dum-e/ai/compat": piAiCompatEntry,
		"@dum-e/ai/oauth": piAiOauthEntry,
		"@dum-e/ai": piAiCompatEntry,
