...
import type { AssistantMessage, Context, Model } from "@dum-e/ai";
...
vi.mock("@dum-e/ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@dum-e/ai/compat")>();
	return {
		...actual,
