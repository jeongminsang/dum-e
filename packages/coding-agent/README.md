...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@dum-e/coding-agent"><img alt="npm" src="https://img.shields.io/npm/v/@dum-e/coding-agent?style=flat-square" /></a>
</p>
...
```bash
npm install -g --ignore-scripts @dum-e/coding-agent
```
...
- [@dum-e/ai](https://www.npmjs.com/package/@dum-e/ai): Core LLM toolkit
- [@dum-e/agent-core](https://www.npmjs.com/package/@dum-e/agent-core): Agent framework
- [@dum-e/tui](https://www.npmjs.com/package/@dum-e/tui): Terminal UI components
