import { CustomEditor, type ExtensionAPI, type ExtensionContext, type KeybindingsManager } from "@dum-e/coding-agent";
import type { Component, EditorTheme, TUI } from "@dum-e/tui";
import { truncateToWidth, visibleWidth } from "@dum-e/tui";
